...
function Contact() {
    return (
        <div id='contact' className='App-contact main2'>
            ...
            <div className="subcontact"  data-aos="zoom-in">
                <div className="contactinfo box5">
                    ...
                    <ContactSection icon="attach_email" location="abuhurairah775@gmail.com" link="mailto:abuhurairah775@gmail.com" target="_blank"/>
                </div>
